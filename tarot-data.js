...
function cardBackSVG(){
  ...
  return `<svg class="card-back-svg" viewBox="0 0 100 150" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
    ...
    <g stroke-linejoin="round" stroke-linecap="round">
      ...
      <!-- ===== 月中央：照描参考图轮廓的「朝左坐姿猫」单线条剪影 =====
           严格按参考线稿走线：鼻尖→额头→左耳尖→耳谷→右耳尖→后颈→大弧背脊→臀→落地；
           另两笔：下巴→前胸→前腿→脚掌；以及由后臀甩出、绕到身前卷成一圈的长尾。 -->
      <!-- 身后淡淡暗晕，强化「月中剪影」的层次 -->
      <ellipse cx="50" cy="68" rx="20" ry="23" fill="${NAVY2}" opacity="0.14"/>
      <g fill="none" stroke="${G}" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round">
        <!-- (1) 主线：鼻尖 → 脸 → 双耳 → 后颈 → 背脊大弧 → 臀 → 坐地 -->
        <path d="M33.4 60.5
                 C 32.8 58.2, 33.6 56.4, 35.4 55.2
                 C 37 54.1, 38.2 52.9, 39 51.4
                 C 39.6 49.4, 39.8 46.6, 40.1 44.4
                 L 41.3 39.4
                 C 42 42.2, 43 44.8, 44.4 46.6
                 C 45.6 44.8, 47 42.9, 48.4 41.8
                 L 50.3 38.6
                 C 51 41.8, 52 44.9, 53.6 47.4
                 C 58.6 52.6, 63.4 58.6, 64.2 66.2
                 C 65 73.2, 63.8 80.2, 60.6 85.2
                 C 59.4 87.5, 57.2 88.2, 55 87.8"/>
        <!-- (2) 下巴 → 前胸 → 前腿 → 脚掌 -->
        <path d="M37 64
                 C 39.2 67.4, 41.2 71, 43 75
                 C 44.2 79, 45.2 83, 45.6 86.6
                 C 45.7 88, 47.2 88.6, 49.2 88.3"/>
      </g>
      <!-- (3) 长尾：由后臀甩出，绕过身前卷成一圈（参考图最具辨识度的一笔） -->
      <path d="M57.8 87.6
               C 49.5 90.4, 39.5 90.6, 32.6 87
               C 27.4 84.3, 27.6 78.8, 31.8 77.6
               C 35.2 76.6, 37.4 79.6, 35.8 81.9
               C 34.7 83.2, 32.8 82.7, 33 80.9"
            fill="none" stroke="${G}" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>
      <!-- 闭眼（侧脸上扬一弧）与鼻尖小点 -->
      <path d="M36.4 56.6 q2.6 -1.5 4.6 0.2" fill="none" stroke="${Gdk}" stroke-width="0.9" stroke-linecap="round"/>
      <circle cx="33.6" cy="59" r="0.9" fill="${RED}" opacity="0.8"/>
