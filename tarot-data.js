...
function cardBackSVG(){
  ...
  return `<svg class="card-back-svg" viewBox="0 0 100 150" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
    ...
    <g stroke-linejoin="round" stroke-linecap="round">
      ...
      <path d="M58 92 C 67 92, 70.5 81, 66.5 74.5 C 64.5 71, 60.5 72, 60 75.5"
            fill="none" stroke="${G}" stroke-width="2.2" stroke-linecap="round"/>
      <!-- 整猫闭合剪影：高尖耳 → 窄脸 → 修长挺直脖颈 → 纤细收腰身躯 → 端坐
           （比例更瘦长英气：肩颈收窄、腰身内收、坐底纤细） -->
      <path d="M50 51
               ...
               C 52.7 51.6, 54.3 53.8, 54.9 57.4
               C 55.6 61.8, 55.7 67.5, 55.2 73.5
               C 54.9 78, 55.2 83.5, 56 88.5
               C 56.3 90.4, 55.6 91.2, 54.2 91.2
               L 51 91.2
               C 50.6 90.6, 50.3 90.2, 50 90.2
               C 49.7 90.2, 49.4 90.6, 49 91.2
               L 45.8 91.2
               C 44.4 91.2, 43.7 90.4, 44 88.5
               C 44.8 83.5, 45.1 78, 44.8 73.5
               C 44.3 67.5, 44.4 61.8, 45.1 57.4
               C 45.7 53.8, 47.3 51.6, 50 51 Z"
            fill="${G}" stroke="${Gdk}" stroke-width="0.8" stroke-linejoin="round"/>
      <!-- 前腿分隔暗线，强化端坐的两条纤长前腿 -->
      <path d="M48 63 C 47.6 73, 47.6 82, 48 90" fill="none" stroke="${Gdk}" stroke-width="0.6" opacity="0.5"/>
      <path d="M52 63 C 52.4 73, 52.4 82, 52 90" fill="none" stroke="${Gdk}" stroke-width="0.6" opacity="0.5"/>
