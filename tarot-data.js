...
function cardBackSVG(){
  ...
  return `<svg class="card-back-svg" viewBox="0 0 100 150" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
    ...
    <g stroke-linejoin="round" stroke-linecap="round">
      ...
      <!-- 优雅卷尾：环绕右侧臀部、尾尖内收上扬（先画，置于身后） -->
      <path d="M61 91 C 71 91, 75 80, 70.5 73 C 68 69, 63.5 70, 63 74"
            fill="none" stroke="${G}" stroke-width="2.4" stroke-linecap="round"/>
      ...
      <path d="M50 52.5
               ...
               C 53.8 53, 56.2 55.2, 57.2 58.8
               C 59 63.5, 60.4 70, 61.3 77
               C 62 82, 62.5 87, 62.1 90
               C 62 91.3, 61.1 91.8, 59.8 91.8
               L 51 91.8
               C 50.6 91.1, 50.3 90.7, 50 90.7
               C 49.7 90.7, 49.4 91.1, 49 91.8
               L 40.2 91.8
               C 38.9 91.8, 38 91.3, 37.9 90
               C 37.5 87, 38 82, 38.7 77
               C 39.6 70, 41 63.5, 42.8 58.8
               C 43.8 55.2, 46.2 53, 50 52.5 Z"
            fill="${G}" stroke="${Gdk}" stroke-width="0.8" stroke-linejoin="round"/>
      <!-- 前腿分隔暗线，强化端坐的两条前腿 -->
      <path d="M46.4 65 C 45.9 74, 45.9 83, 46.4 90.4" fill="none" stroke="${Gdk}" stroke-width="0.7" opacity="0.55"/>
      <path d="M53.6 65 C 54.1 74, 54.1 83, 53.6 90.4" fill="none" stroke="${Gdk}" stroke-width="0.7" opacity="0.55"/>
