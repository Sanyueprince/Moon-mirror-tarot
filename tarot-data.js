...
function cardBackSVG(){
  ...
  return `<svg class="card-back-svg" viewBox="0 0 100 150" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
    ...
    <g stroke-linejoin="round" stroke-linecap="round">
      ...
      <!-- 整只猫居中于月盘：高度保持 1.28 倍（充满月亮），宽度加宽到 1.3 倍 → 非等比 scale(1.3,1.28)，以猫中心(50,59.7)为基准 -->
      <g transform="translate(50,66) scale(1.3,1.28) translate(-50,-59.7)">
      ...
      <path d="M50 51
               ...
               C 52.7 51.5, 54.3 53.2, 54.9 56
               C 55.6 60, 55.8 64.5, 55.4 69
               C 55.1 72.5, 55.3 76.5, 56 80
               C 56.3 81.6, 55.6 82.4, 54.2 82.4
               L 51 82.4
               C 50.6 81.8, 50.3 81.4, 50 81.4
               C 49.7 81.4, 49.4 81.8, 49 82.4
               L 45.8 82.4
               C 44.4 82.4, 43.7 81.6, 44 80
               C 44.7 76.5, 44.9 72.5, 44.6 69
               C 44.2 64.5, 44.4 60, 45.1 56
               C 45.7 53.2, 47.3 51.5, 50 51 Z"
